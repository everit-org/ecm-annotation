...
/**
 * Annotation of the {@link String} attribute of a component.
 */
...
public @interface StringAttribute {
  ...
  /**
   * A descriptive text to provide the client in a form to configure this attribute. This name may
   * be localized by prepending a % sign to the name. Default value: %&lt;name&gt;.description
   */
  String description() default "";

  /**
   * If true, the attribute is updated without restarting the component. If the attribute has a
   * setter, it is called during the update.
   */
   ...
   * defined as parameters to the {@link StringAttribute} annotation. All parameters in the form of
