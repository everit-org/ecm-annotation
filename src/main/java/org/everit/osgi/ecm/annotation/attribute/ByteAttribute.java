...
/**
 * Annotation of the {@link Byte} attribute of a component.
 */
...
public @interface ByteAttribute {
   ...
   * defined as parameters to the {@link ByteAttribute} annotation. All parameters in the form of
   ...
   */
  ByteAttributeOption[] options() default {};
