...
/**
 * Annotation of the {@link Character} attribute of a component. Options are shown normally as combo
...
public @interface CharacterAttribute {
   ...
   * defined as parameters to the {@link CharacterAttribute} annotation. All parameters in the form
   * of name-value pairs are used to build the list of available value options. The parameter name
