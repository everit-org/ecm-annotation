...
public @interface CharacterAttribute {
     ...
     * {@link CharacterAttribute} annotation. All parameters in the form of name-value pairs are used to build the list
     * of available value options. The parameter name is used as the value while the parameter value is used as the
     * label in the user interface. This label may be prepended with a % sign to localize the string.
     */
